...
public class MatchesController implements Initializable {
    ...
    @FXML
    private TableColumn<Matches, String> colMatchId;
    @FXML
    private TableColumn<Matches, String> colTeam1;
    @FXML
    private TableColumn<Matches, String> colTeam2;
    @FXML
    ...
    public TableColumn<Matches, String> getColMatchId() {
        return colMatchId;
    }

    public TableColumn<Matches, String> getColTeam1() {
        return colTeam1;
    }

    public TableColumn<Matches, String> getColTeam2() {
        return colTeam2;
    }
